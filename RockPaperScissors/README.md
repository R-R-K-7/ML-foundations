...
to enable the users to play a game of rock-paper-scissors with the model classifying the hand gestures in real-time.
## Dependencies
* `ultralytics (YOLO)`
* `torch`
* `cv2`
...
## Methodology 
This object detection model has been trained upon YOLOv8 nano model. 
